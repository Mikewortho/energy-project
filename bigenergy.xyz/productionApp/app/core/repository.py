...
class Repository():
    ...
    def getResources(self):
        ...
        resources.append(Resource('Modular Applications with Blueprints',
                                  'http://flask.pocoo.org/docs/blueprints/#blueprints'))
        resources.append(Resource('Flask Mega-Tutorial',
                                  'http://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-xv-ajax'))
        resources.append(Resource('The googlesite', 'https://www.google.com'))
        return resources
